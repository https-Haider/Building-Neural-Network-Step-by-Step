...
def L_model_backward(AL, Y, caches):
    ...
    # Initializing the backpropagation (derivative of cross-entropy cost w.r.t AL)
    ...
    # Loop from l=L-2 to l=0 for layers using ReLU
